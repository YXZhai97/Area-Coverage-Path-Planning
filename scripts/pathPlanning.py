...
if gv.random_initial_state:
    ...
    robot1 = robotList[0]
    robot1.set_init_state(43,35)
    robot1.set_init_target(40,38)
    robot1.r_tan=0.85*r_tan
    #
    robot2 = robotList[1]
    robot2.set_init_state(24,14)
    robot2.set_init_target(23,19)
    robot2.r_tan = 1 * r_tan
    #
    robot3 = robotList[2]
    robot3.set_init_state(17,24)
    robot3.set_init_target(12,21)
